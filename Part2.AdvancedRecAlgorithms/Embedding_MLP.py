...
class Embedding_MLP(nn.Module):
    ...
    """
    def __init__(self, total_user_features, total_item_features, n_user_features, n_item_features, dim=64):
    ...
    def forward(self, u, i):
        ...
        ui = torch.cat([user_embs, item_emb_sum], dim=1)
...
if __name__ == "__main__":
    ...
    model = initialize_model(total_user_features=x_train[0].max().item() + 1, 
                             ...
                             n_item_features=1, # 这里没有把类别embbeding相加，也可以相加，那么这里就只有1个类别特征
                             n_factors=n_factors)
